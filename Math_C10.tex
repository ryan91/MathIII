...
\subsection{Beispiele}
	\subExBegin{a)}
		...
		\item Ebenso Funktionen wie $f\lrr{x_1,x_2} = \sin\lrr{x_1\cdot x_2}+e^{x_2}$\\
			...
			$\frac{\parital^2f}{\lrr{\partial x_1}^2} = -x_2^2\cdot\sin\lrr{x_1,x_2}$\\
...
\subsection{Satz von Schwarz}
	...
	$\Rightarrow \frac{\partial^2 f}{\partial x_i\parital x_j}=\frac{\partial^2 f}{\partial x_j\partial x_i}$ für alle $i,j$
