...
$f(g_1-g_2)=0\underset{\scriptstyle{a),f\neq 0}}{\Rightarrow} g_1-g_2=0$, d.h. $g_1=g_2$
	...
	Gibt es $m+1$ viele viele paarweise verschiedene Elemente $a_1,...,a_{m+1}\in K$ mit $f(a_i)=g(a_i)$, $i=1,..,m+1$, dann ist $f=g$. Insbesondere ist $\lrabs{K}=\infty$, $f,g\in K[x]$ mit $f(a)=g(a)$ für alle $a\in K$, so ist $f=g$.
